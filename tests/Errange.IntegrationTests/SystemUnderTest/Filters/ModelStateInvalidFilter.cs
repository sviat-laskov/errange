...
namespace Errange.IntegrationTests.SystemUnderTest.Filters;
...
public class ModelStateInvalidFilter : IActionFilter, IOrderedFilter
{
    ...
    {
        if (context.Result == null && !context.ModelState.IsValid) context.Result = _apiBehaviorOptions.InvalidModelStateResponseFactory(context);
    }
